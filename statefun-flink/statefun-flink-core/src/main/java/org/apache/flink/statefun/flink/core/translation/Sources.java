    ...
    sourceFunctions.forEach(
            (id, sourceFunction) -> {
              ...
              if (sourceWrapper == null) {
                ...
                stream = rowDataStream.map(new RowDataToMessageMapFunction(sourceWrapper.getIdFieldName(), sourceWrapper.getTimestampIdFieldName(),
                        sourceWrapper.getRoutingConfig(), sourceWrapper.getTableFields(), new DefaultJsonNodeGeneratorFactory()));
              }
